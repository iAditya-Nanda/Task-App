    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError(data.message || (data.errors ? data.errors.map((err: any) => err.message).join('. ') : 'Registration failed'));
            }
        } catch (err: any) {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-theme-bg relative overflow-hidden selection:bg-purple-100 selection:text-purple-900">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full overflow-hidden -z-10 pointer-events-none">
                ...
                <div className="absolute top-[-20%] right-[10%] w-96 h-96 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
            </div>
            ...
            >
                <div className="text-center mb-10">
                    <h2 className="text-[28px] font-extrabold text-theme-textMain mb-2 tracking-tight">Create Account</h2>
                    <p className="text-theme-textMuted text-[15px] font-medium">Join to organize everything in one place.</p>
                </div>
                ...
                <div className="mt-8 text-center text-[14px] font-medium text-theme-textMuted">
                    ...
                    <Link href="/login" className="font-extrabold text-black hover:text-purple-600 hover:underline hover:underline-offset-4 transition-all">
                        Log in instead
                    </Link>
                </div>
            </motion.div>
